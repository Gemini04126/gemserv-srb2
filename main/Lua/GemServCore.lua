...
--			v.drawString(20, 60, "this won't display so fuck it lmao", V_ALLOWLOWERCASE, "left")
--		end
--	end
--end, "game")
...
L0    : Players cannot use any cheats or commands that affect the server or other people. This is equal to having no permissions at all.
L1 (+): Players can only use cheats that affect themselves, such as "god" and "noclip".
L2 (#): Players can only use all cheats.
L3 (&): Players can execute any command.]],
...
This mod for SRB2 servers adds lots of additional functionality to improve the netplay experience, such as a better permissions system, and optional multiplayer cheats!

To read more, type "term_help <topic>". The following topics are available:
]]
